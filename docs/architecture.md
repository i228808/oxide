...
├── oxide_framework_core/         # Framework library (the main crate)
├── oxide_framework_macros/       # Proc-macro crate (#[controller], route attributes)
